...
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:393
_, _ = io.WriteString(w, "(avg:jmx.org.cloudfoundry.system.healthy{deployment:")
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:393
...
_, _ = io.WriteString(w, html.EscapeString(fmt.Sprintf("%v",  d.Release )))
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:1619
_, _ = io.WriteString(w, "} by {job,index}\",\n            \"conditional_formats\": [],\n            \"type\": \"line\"\n          }\n        ]\n      },\n      \"width\": 24,\n      \"timeframe\": \"1h\",\n      \"y\": 50,\n      \"x\": 134,\n      \"legend_size\": \"0\",\n      \"type\": \"timeseries\",\n      \"legend\": false\n    },\n    {\n      \"title_size\": 16,\n      \"title\": true,\n      \"title_align\": \"left\",\n      \"title_text\": \"CPU Utilization for ERT (%) - 1h\",\n      \"height\": 12,\n      \"tile_def\": {\n        \"viz\": \"heatmap\",\n        \"requests\": [\n          {\n            \"q\": \"max:jmx.org.cloudfoundry.system.cpu.user{deployment:")
...
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, "avg:jmx.org.cloudfoundry.system.cpu.user{deployment:")
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, html.EscapeString(fmt.Sprintf("%v",  d.Release )))
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, ",job:")
...
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
 for _, routerJob := range d.RouterJobs { 
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, "avg:jmx.org.cloudfoundry.system.cpu.sys{deployment:")
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, html.EscapeString(fmt.Sprintf("%v",  d.Release )))
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, ",job:")
...
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
 if i == len(d.RouterJobs ) - 1 { 
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, "avg:jmx.org.cloudfoundry.system.cpu.wait{deployment:")
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, html.EscapeString(fmt.Sprintf("%v",  d.Release )))
//line templates/screen/PCF-stoplights-template-opsmetrics.json.ego:2229
_, _ = io.WriteString(w, ",job:")
...
_, _ = io.WriteString(w, "\n          {\n            \"q\": \"avg:jmx.org.cloudfoundry.opentsdb.nozzle.gorouter.latency{deployment:cf,job:")
...
_, _ = io.WriteString(w, "\n        ],\n        \"markers\": [\n          {\n            \"dim\": \"y\",\n            \"type\": \"error dashed\",\n            \"val\": 0,\n            \"value\": \"y = 0\"\n          }\n        ]\n      },\n      \"width\": 54,\n      \"timeframe\": \"30m\",\n      \"y\": 39,\n      \"x\": 0,\n      \"legend_size\": \"0\",\n      \"type\": \"timeseries\",\n      \"legend\": true\n    },\n    {\n      \"board_id\": 66559,\n      \"title_size\": 16,\n      \"title\": true,\n      \"title_align\": \"left\",\n      \"title_text\": \"App Requests /sec past 30min\",\n      \"height\": 11,\n      \"tile_def\": {\n        \"viz\": \"timeseries\",\n        \"requests\": [\n          {\n            \"q\": \"per_second(avg:jmx.org.cloudfoundry.opentsdb.nozzle.gorouter.total_requests{deployment:cf})\",\n            \"aggregator\": \"avg\",\n            \"conditional_formats\": [],\n            \"type\": \"line\"\n          }\n        ]\n      },\n      \"width\": 54,\n      \"timeframe\": \"30m\",\n      \"y\": 62,\n      \"x\": 0,\n      \"legend_size\": \"0\",\n      \"type\": \"timeseries\",\n      \"legend\": false\n    }\n  ],\n  \"shared\": false,\n  \"id\": 66559,\n  \"title_edited\": false\n}\n")
return nil
}
